...
# pdf("isl_transport.pdf")
png("isl_transport.png",  
  width     = 6,
  height    = 6,
  units     = "in",
  res=360)
...
ggtitle("Island Model Transport Interval Trends") +  
theme_bw() +
...
geom_point(fill="white", color="black", size=0.75, shape=1, alpha=1/3)+
facet_wrap( ~ type, scale="free", ncol=2) + 
ggtitle("Embodied Model Transport Interval Trends") +  
theme_bw() +
theme(text = element_text(size = 9)))
...
geom_point(fill="white", color="black", size=0.75, shape=1, alpha=1/3)+
facet_wrap( ~ type, scale="free", ncol=2) + 
ggtitle("ALife Model Transport Interval Tends") +  
theme_bw() +
theme(text = element_text(size = 9)))
