...
computeBootStatsI <-function(f.orig.data.frame, p.orig.data.frame) {
	...
	for(var.interaction in unique(f.orig.data.frame$INTERACTIONS)) {
			print(var.interaction)

			f <- data.frame()
			p <- data.frame()
			
			f.data.frame <- f.orig.data.frame[f.orig.data.frame$INTERACTIONS==var.interaction,]
			
			p.data.frame <- p.orig.data.frame[p.orig.data.frame$INTERACTIONS==var.interaction,]
