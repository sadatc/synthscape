...
#random
row_data <- read.csv(file="/tmp/sum_me_reg_24_m111.csv")
row_data <- cbind(env="m111",row_data)
...
row_data <- read.csv(file="/tmp/sum_me_reg_24_m112.csv")
row_data <- cbind(env="m112",row_data)
row_data <- cbind(pop="24",row_data)
data <- rbind(data,row_data)

row_data <- read.csv(file="/tmp/sum_me_reg_24_m121.csv")
row_data <- cbind(env="m121",row_data)
row_data <- cbind(pop="24",row_data)
data <- rbind(data,row_data)


row_data <- read.csv(file="/tmp/sum_me_reg_24_m211.csv")
row_data <- cbind(env="m211",row_data)
row_data <- cbind(pop="24",row_data)
data <- rbind(data,row_data)
