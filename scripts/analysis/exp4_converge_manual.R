...
MEAN_FILE_NAME <- "exp4_man_experiments_mean_"
...
meanifyCSVS <-function(directory, aggregateData, howManyGenerations) {
	...
	#for(i in 1:2) {
		...
		r <- substr(csvFileName,8,10)
		ratio <- paste(substr(r,1,1),substr(r,2,2),substr(r,3,3),sep=':')
		#print(ratio)
		#stop()

		#print(evennessControl)
		#print(extractedResources)
...
meanifyExp4Data("/Users/sadat/ExperimentResults/Evenness/data/manual/",
