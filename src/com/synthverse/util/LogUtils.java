...
public final class LogUtils implements Constants {
	...
	public enum LogFormatter {
		...
		DEFAULT(new LogUtils.BareBonesFormatter()), TIMED_BAREBONES(
				new LogUtils.TimedBareBonesFormatter()), CUSTOM_SIMPLE(
	...
	private static class TimedBareBonesFormatter extends
