...
public enum Instruction {
	...
	CODE_SWAP_IA("CODE.SWAP_IA") {
		public void execute(VirtualMachine virtualMachine) {
			...
			GenotypeInstruction[] saved_cs = cs.getInternalArray();
	...
	CODE_COPY_TO_IA("CODE.COPY_TO_IA") {
		public void execute(VirtualMachine virtualMachine) {
			...
			CodeStack cs = virtualMachine.getCodeStack();
			Genotype ia = virtualMachine.getInstructionArray();
			GenotypeInstruction[] cs_array = cs.getInternalArray();
			int size = cs.size();
	...
	CODE_COPY_FROM_IA("CODE.COPY_FROM_IA") {
		public void execute(VirtualMachine virtualMachine) {
			...
			CodeStack cs = virtualMachine.getCodeStack();
			Genotype ia = virtualMachine.getInstructionArray();
			GenotypeInstruction[] ia_array = ia.getInternalArray();
	...
	ACTION_UNICAST_CLOSEST_A("ACTION.UNI_CLOSE_A") {
		public void execute(VirtualMachine virtualMachine) {
			virtualMachine.getAgent().operationUnicastClosest(
					SignalType.SIGNAL_A);
			virtualMachine.incrementIP();
		}
	...
	ACTION_FOLLOW_UNICAST_CLOSEST_A("ACTION.FOLLOW_UNI_CLOSE_A") {
		public void execute(VirtualMachine virtualMachine) {
			virtualMachine.getAgent().operationFollowUnicastClosest(
					SignalType.SIGNAL_A);
			virtualMachine.incrementIP();
		}
	...
	ACTION_FOLLOW_UNICAST_CLOSEST_B("ACTION.FOLLOW_UNI_CLOSE_B") {
		public void execute(VirtualMachine virtualMachine) {
			virtualMachine.getAgent().operationFollowUnicastClosest(
					SignalType.SIGNAL_B);
			virtualMachine.incrementIP();
	...
	ACTION_FOLLOW_UNICAST_CLOSEST_C("ACTION.FOLLOW_UNI_CLOSE_C") {
		public void execute(VirtualMachine virtualMachine) {
			virtualMachine.getAgent().operationFollowUnicastClosest(
					SignalType.SIGNAL_C);
			virtualMachine.incrementIP();
	...
	ACTION_DETECT_UNICAST_CLOSEST_A("ACTION.DETECT_UNI_CLOSE_A") {
		public void execute(VirtualMachine virtualMachine) {
			virtualMachine.getBooleanStack().push(
					virtualMachine.getAgent().operationDetectUnicastClosest(
							SignalType.SIGNAL_A));
			virtualMachine.incrementIP();
		}
	...
	ACTION_DETECT_UNICAST_CLOSEST_B("ACTION.DETECT_UNI_CLOSE_B") {
		public void execute(VirtualMachine virtualMachine) {
			virtualMachine.getBooleanStack().push(
					virtualMachine.getAgent().operationDetectUnicastClosest(
							SignalType.SIGNAL_B));
	...
	ACTION_DETECT_UNICAST_CLOSEST_C("ACTION.DETECT_UNI_CLOSE_C") {
		public void execute(VirtualMachine virtualMachine) {
			virtualMachine.getBooleanStack().push(
					virtualMachine.getAgent().operationDetectUnicastClosest(
							SignalType.SIGNAL_C));
	...
	ACTION_IS_CARRYING_EXTRACTED_RESOURCE(
			"ACTION.IS_CARRYING_EXTRACTED_RESOURCE") {
		public void execute(VirtualMachine virtualMachine) {
			virtualMachine
					.getBooleanStack()
					.push(virtualMachine.getAgent().isCarryingResource()
							&& virtualMachine.getAgent()
									.getStateOfCarriedResource() == ResourceState.EXTRACTED);
			virtualMachine.incrementIP();
		}

	},

	ACTION_IS_CARRYING_PROCESSED_RESOURCE(
			"ACTION.IS_CARRYING_PROCESSED_RESOURCE") {
		public void execute(VirtualMachine virtualMachine) {
			virtualMachine
					.getBooleanStack()
					.push(virtualMachine.getAgent().isCarryingResource()
							&& virtualMachine.getAgent()
									.getStateOfCarriedResource() == ResourceState.PROCESSED);
			virtualMachine.incrementIP();
		}
	...
	ACTION_IS_CARRYING_RAW_RESOURCE("ACTION.IS_CARRYING_RAW_RESOURCE") {
		public void execute(VirtualMachine virtualMachine) {
			virtualMachine
					...
					.push(virtualMachine.getAgent().isCarryingResource()
							&& virtualMachine.getAgent()
									.getStateOfCarriedResource() == ResourceState.RAW);
			virtualMachine.incrementIP();
		}
