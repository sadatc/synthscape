...
public final class GeneticOperator {
	...
	public final static void pointMutate(
		...
		GenotypeInstruction[] offspringDNA = offspring.getProgram()
				.getGenotypeArray();
	...
	public final static void cross(MersenneTwisterFast randomNumberGenerator,
		...
		GenotypeInstruction[] offspringDNA = offspring.getProgram()
				.getGenotypeArray();
		GenotypeInstruction[] parentA_DNA = parentA.getProgram()
				.getGenotypeArray();
		GenotypeInstruction[] parentB_DNA = parentB.getProgram()
				.getGenotypeArray();
