...
public class FancySimulationUI extends SimulationUI {
	...
	collectionSitePortrayal.setPortrayalForAll(new FacetedPortrayal2D(new SimplePortrayal2D[] {
	...
	initPortrayal(obstaclesPortrayal, theState.obstacleGrid, new sim.util.gui.SimpleColorMap(ABSENT, PRESENT,
		new Color(0, 0, 0, 0), Color.BLACK));

	initPortrayal(trailPortrayal, theState.trailGrid, new sim.util.gui.SimpleColorMap(TRAIL_LEVEL_MIN,
	...
	agentPortrayal.setPortrayalForAll(new FacetedPortrayal2D(new SimplePortrayal2D[] {
	...
	worldPortrayal.setPortrayalForAll(new RectanglePortrayal2D(Color.LIGHT_GRAY, false));
